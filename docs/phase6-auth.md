...
4. ⬜ UI: экран логина/регистрации, «вошёл как…», убрать ручной ввод ника.
5. ⬜ Скины: кнопка → диалог PNG → `validate_skin` → `upload_skin` + `skinview3d`-превью.
6. ⬜ MC-сервер: injector + online-mode → реальный e2e.
7. ⬜ Polish: авто-refresh, выход, понятные ошибки.
